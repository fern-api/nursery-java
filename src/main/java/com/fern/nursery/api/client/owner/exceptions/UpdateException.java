package com.fern.nursery.api.client.owner.exceptions;
...
public final class UpdateException extends Exception {
  ...
  public static UpdateException ownerNotFoundError(OwnerNotFoundError value) {
    return new UpdateException(new OwnerNotFoundErrorValue(value), 404);
  }
  ...
  private static final class OwnerNotFoundErrorValue implements Value {
    ...
    public String toString() {
      return "UpdateException{" + "value: " + value + ", errorInstanceId: " + errorInstanceId + "}";
    }
  }
