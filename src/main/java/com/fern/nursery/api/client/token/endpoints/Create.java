...
public final class Create {
  ...
  public static final class Request {
    private final CreateTokenRequest body;

    private int _cachedHashCode;

    Request(CreateTokenRequest body) {
      this.body = body;
    }

    public CreateTokenRequest getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(CreateTokenRequest body);
    ...
    static final class Builder implements BodyStage, _FinalStage {
      private CreateTokenRequest body;
      ...
      @Override
      public _FinalStage body(CreateTokenRequest body) {
        this.body = body;
        return this;
      }
