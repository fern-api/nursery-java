...
public final class GetException extends Exception {
  ...
  public static GetException ownerNotFoundError(OwnerNotFoundError value) {
    return new GetException(new OwnerNotFoundErrorValue(value), 404);
  }
  ...
  private static final class OwnerNotFoundErrorValue implements Value {
    ...
    public String toString() {
      return "GetException{" + "value: " + value + ", errorInstanceId: " + errorInstanceId + "}";
    }
  }
